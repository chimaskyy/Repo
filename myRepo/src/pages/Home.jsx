...
const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen min-h-screen bg-gradient-to-r from-purple-500 to-pink-500 bg-opacity-25 p-6">
      <div>
        <h1 className="text-center text-3xl font-bold mt-6">RepoView</h1>
        <h1 className="text-center text-2xl font-bold mt-6">
          Welcome GitHub Portfolio viewer
        </h1>
        <p className="text-center mt-4 text-2xl text-white md:text-center 2xl:text-justify">
